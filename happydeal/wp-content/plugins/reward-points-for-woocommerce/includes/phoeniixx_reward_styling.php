			...
			<table class="form-table" style="width:50%;">
				...
				<th> 
					...
					<td>
						...
						<input class="btn_num"  placeholder="RIGHT" style="max-width:65px;font-size:12px;" min="0" name="apply_rightmargin" 	type="number" value="<?php echo(isset($gen_settings['rightmargin'])) ?$gen_settings['apply_rightmargin']:'10';?>">
				...
				<tr class="btn_bor">
					...
					<td>
						...
						<input class="btn_num"  type="number" name="apply_btn_border" style="max-width:105px;" value="<?php echo(isset($gen_settings['apply_btn_border'])) ?$gen_settings['apply_btn_border']:'0';?>">px
				...
				<tr>
					...
					<td>
						...
						<input  class="btn_num" type="number" style="max-width:105px;" name="apply_btn_rad" value="<?php echo(isset($gen_settings['apply_btn_rad'])) ?$gen_settings['apply_btn_rad']:'0';?>">px
				...
				<tr class="btn_bor">
					...
					<td>
						...
						<input class="btn_num"  type="number" name="div_border" style="max-width:105px;" value="<?php echo(isset($gen_settings['div_border'])) ?$gen_settings['div_border']:'1';?>">px
				...
				<tr>
					...
					<td>
						...
						<input  class="btn_num" type="number" style="max-width:105px;" name="div_rad" value="<?php echo(isset($gen_settings['div_rad'])) ?$gen_settings['div_rad']:'0';?>">px
