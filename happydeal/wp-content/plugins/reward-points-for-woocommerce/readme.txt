...
[LIVE DEMO](http://reward.phoeniixxdemo.com/wp-admin) | [PREMIUM VERSION LINK](https://www.phoeniixx.com/product/reward-points-for-woocommerce/)
...
* Option to set the Category Based Points.
...
* Number of month can be set for the points expiry.
* Can also set the validity date for point assignment for categories or single product.
...
* Option to set the limit of the reward points use
