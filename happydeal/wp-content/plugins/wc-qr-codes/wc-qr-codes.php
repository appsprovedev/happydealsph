...
if (!class_exists('WooCommerceQrCodes')) :
    ...
    final class WooCommerceQrCodes {
        ...
        public function load_text_domain() {
            ...
            load_textdomain('wc-qr-codes', WP_LANG_DIR . "/plugins/$text_domain_to_load.mo");
            load_textdomain('wc-qr-codes', trailingslashit(dirname(__FILE__)) . "/languages/$text_domain_to_load.mo");
        }
