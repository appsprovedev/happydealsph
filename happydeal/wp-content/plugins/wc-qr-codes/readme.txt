...
QR code (abbreviated from Quick Response Code) is the trademark for a type of matrix barcode. WooCommerce QR Codes generate QR Codes for every woocommerce products.
