...
<div class="container-fluid imgBG" style='background-image: url("/images/partners.jpg"); padding-left: 0; padding-right: 0; width: 100%;'>
...
<br>
        <ul class="tab-links">
            <li class="active"><a href="#tab1">DINING</a> <hr/></li>
            <li><a href="#tab2">HOTELS</a><hr/></li>
            <li><a href="#tab3">GETAWAYS</a><hr/></li>
            <li><a href="#tab4">BEAUTY & WELLNESS</a><hr/></li>
        </ul>
