<?php if ( couponhut_get_field('image_type') == 'image' ) { ?>

	<?php $image = couponhut_get_field('header_image') ? couponhut_get_field('header_image') : couponhut_get_field('image'); ?>
	<?php if ( $image ) : ?>
	...
	<div class="single-deal-slider">
		...
		if( couponhut_have_rows('slider') ):
		   ...
		   while ( couponhut_have_rows('slider') ) : the_row(); ?>
				...
				<?php // couponhut_get_sub_field('image'); ?>
				<?php $image = couponhut_get_sub_field('image'); ?>
				<?php if ( $image ) : ?>
...
<?php } //end couponhut_get_field('image_type') check ?>
