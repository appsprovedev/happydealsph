	...
	<div class="header-screen-content">
		<form action="<?php echo esc_url( home_url( "/" ) ); ?>" method="get" class="form-deal-submit header-screen-search">
			...
			<div class="header-screen-geolocation-fields clearfix">
				<?php
				if ( fw_ssd_get_option('geolocation-switch') && !fw_ssd_get_option('hide-country') ) :
				?>
					...
					?>
				<?php 
				endif //if fw_ssd_get_option('geolocation-switch') && !fw_ssd_get_option('hide-country');
				?>
				<?php
				if ( fw_ssd_get_option('geolocation-switch') && fw_ssd_get_option('hide-country') ) :
				?>
					<span><?php esc_html_e('city', 'couponhut');?></span>
					<?php
					if ( !empty($_GET['deal_city']) ) {
						$deal_city_current = $_GET['deal_city'];
					} else {
					...
					?>
				<?php 
				endif //fw_ssd_get_option('geolocation-switch') && !fw_ssd_get_option('hide-country');
				?>
				...
				<?php if ( fw_ssd_get_option('geolocation-switch') ) : ?>
					<?php if ( !fw_ssd_get_option('hide-country') ) : ?>
