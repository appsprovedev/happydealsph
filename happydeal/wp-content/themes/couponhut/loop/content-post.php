<article class="single-post-wrapper">
	...
	<div class="single-post-content">
		...
		<div class="single-post-meta">
			...
			?>
			<?php if ( get_the_date(get_option('date_format')) ) :  ?>
		...
		<div class="single-post-main-content">
			<?php 
				if ( fw_ssd_get_option('post-content-switch') == 'content' || is_singular() ) {
					the_content();
				} else {
					the_excerpt();	
				}
		...
		wp_link_pages( array(
				'before'      => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'couponhut' ) . '</span>',
				'after'       => '</div>',
				'link_before' => '<span>',
				'link_after'  => '</span>',
			) );
