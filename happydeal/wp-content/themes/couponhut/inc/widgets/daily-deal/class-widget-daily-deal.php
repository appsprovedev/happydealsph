...
Class SSD_Widget_Daily_Deal extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<?php 
		$deal_image = couponhut_get_field('image', $instance['daily_deal']);
		?>
		...
		if ( $title ) { echo $before_title . $title . $after_title; } ?>
			...
			<div class="daily-deal-content">
				...
				<div class="daily-deal-expiring">
					<div class="jscountdown-wrap" data-time="<?php echo esc_attr( couponhut_get_field('expiring_date', $instance['daily_deal']) ); ?>"></div>
				</div>
				<?php endif; ?>
			</div>
