...
if ( is_admin() ) {
	...
	// wp_enqueue_script(
	// 	'ssd_admin_gmapsapi', 
	// 	'https://maps.googleapis.com/maps/api/js?v=3.exp&key='. fw_ssd_get_option('google-api-key'),
	// 	null,
	// 	null,
	// 	true
	// 	);
...
if ( is_page_template( 'template-contact.php' ) || is_singular('deal') ) {
	wp_enqueue_script(
		'ssd_gmapsapi', 
		'https://maps.googleapis.com/maps/api/js?v=3.exp&amp;sensor=false&key='. fw_ssd_get_option('google-api-key'),
		'jquery',
		'1.0',
		false
		);
...
wp_localize_script( 'ssd_fw-theme-script', 'couponhut', array(
		...
		'redeemed' => esc_html__('Deal Redeemed', 'couponhut'),
