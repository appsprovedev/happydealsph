 ...
 * @author   WooThemes
 */
class WC_CouponHut_Deal extends WC_Abstract_Legacy_Product {

	/**
	 * This is the name of this object type.
	 * @var string
	 */
	protected $object_type = 'deal';

	/**
	 * Post type.
	 * @var string
	 */
	protected $post_type = 'deal';

	/**
	 * Cache group.
	 * @var string
	 */
	protected $cache_group = 'deals';
	 ...
	 *
	 * @param int|WC_CouponHut_Deal|object $product Product to init.
	 */
	public function __construct( $product = 0 ) {
		...
		$this->data_store = WC_Data_Store::load( 'dealdata' );
		if ( $this->get_id() > 0 ) {
